...
Rating controls display text that does not require user input. They often serve as Labels for other controls or areas of the widget. They also can be used to display icons that add context to the user interface.

|

.. image:: ../images/gcs/dfx-rating.png
