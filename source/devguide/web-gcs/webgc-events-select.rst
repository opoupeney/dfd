...
+==================+=================+====================================================================================================+
| On Open:         | *function name* | The function is executed when the select control is opened triggering the On Open event.           |
+------------------+-----------------+----------------------------------------------------------------------------------------------------+
| On Close:        | *Function Name* | he function is executed when the select control is closed triggering the On Close event.           |
+------------------+-----------------+----------------------------------------------------------------------------------------------------+
