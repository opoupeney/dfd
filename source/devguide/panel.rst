...
+========================+===================+============================================================================================+
| On Click               | function name     | Enter the name of the function that will be executed when the user clicks on the Image.    |
|                        |                   | The function should be defined in the controller in the script tab of the Widget Editor.   |
|                        |                   | Clicking on the ... opens a window to to select a function defineded in the Controller.    |
+------------------------+-------------------+--------------------------------------------------------------------------------------------+
