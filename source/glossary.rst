...
.. glossary::
    ...
    GC
       GC is an abbreviation for Graphical Control. DreamFace provides predefined Graphical Controls like input fields, button, graphs, etc. in the View Editor that can be used to define the :term:`UI` of a DreamFace application.
    grunt
